...
async def run_migrations():
    # Create a separate migrations directory for tests
    os.system("alembic init test_migrations")
    os.system('alembic -c test_migrations/alembic.ini revision --autogenerate -m "test running migrations"')
    os.system("alembic -c test_migrations/alembic.ini upgrade heads")
